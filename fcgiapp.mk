#############################################################################
# Makefile for building: _bin/fcgiapp
# Generated by qmake (3.1) (Qt 5.15.19)
# Project:  fcgiapp.pro
# Template: app
# Command: /usr/bin/qmake -o fcgiapp.mk fcgiapp.pro
#############################################################################
...
INCPATH       = -I. -Ifcgi/include -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = fcgiapp1.0.0
DISTDIR = /home/soramimi/develop/fcgiexample/build/fcgiapp-obj/fcgiapp1.0.0
LINK          = g++
...
OBJECTS_DIR   = build/fcgiapp-obj/

####### Files

SOURCES       = fcgi/libfcgi/fcgi_stdio.c \
		fcgi/libfcgi/fcgiapp.c \
		app/myfcgi.c \
		app/main.cpp \
		serv/debug.cpp \
		fcgi/libfcgi/os_unix.c 
OBJECTS       = build/fcgiapp-obj/fcgi_stdio.o \
		build/fcgiapp-obj/fcgiapp.o \
		build/fcgiapp-obj/myfcgi.o \
		build/fcgiapp-obj/main.o \
		build/fcgiapp-obj/debug.o \
		build/fcgiapp-obj/os_unix.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		fcgiapp.pro fcgi/include/fastcgi.h \
		...
		app/myfcgi.h \
		serv/debug.h fcgi/libfcgi/fcgi_stdio.c \
		fcgi/libfcgi/fcgiapp.c \
		app/myfcgi.c \
		app/main.cpp \
		serv/debug.cpp \
		fcgi/libfcgi/os_unix.c
QMAKE_TARGET  = fcgiapp
DESTDIR       = _bin/
TARGET        = _bin/fcgiapp
...
_bin/fcgiapp:  $(OBJECTS)  
	@test -d _bin/ || mkdir -p _bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

fcgiapp.mk: fcgiapp.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		fcgiapp.pro
	$(QMAKE) -o fcgiapp.mk fcgiapp.pro
...
build/fcgiapp-obj/fcgi_stdio.o: fcgi/libfcgi/fcgi_stdio.c fcgi/include/fcgi_config.h \
		fcgi/include/fcgiapp.h \
		fcgi/include/fcgios.h \
		fcgi/include/fcgimisc.h \
		fcgi/include/fcgi_stdio.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/fcgiapp-obj/fcgi_stdio.o fcgi/libfcgi/fcgi_stdio.c

build/fcgiapp-obj/fcgiapp.o: fcgi/libfcgi/fcgiapp.c fcgi/include/fcgi_config.h \
		fcgi/include/fcgimisc.h \
		fcgi/include/fastcgi.h \
		fcgi/include/fcgios.h \
		fcgi/include/fcgiapp.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/fcgiapp-obj/fcgiapp.o fcgi/libfcgi/fcgiapp.c

build/fcgiapp-obj/myfcgi.o: app/myfcgi.c app/myfcgi.h \
		fcgi/include/fcgi_config.h \
		fcgi/include/fcgi_stdio.h \
		fcgi/include/fcgiapp.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/fcgiapp-obj/myfcgi.o app/myfcgi.c

build/fcgiapp-obj/main.o: app/main.cpp app/myfcgi.h \
		fcgi/include/fcgi_config.h \
		fcgi/include/fcgi_stdio.h \
		fcgi/include/fcgiapp.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/fcgiapp-obj/main.o app/main.cpp

build/fcgiapp-obj/debug.o: serv/debug.cpp serv/debug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/fcgiapp-obj/debug.o serv/debug.cpp

build/fcgiapp-obj/os_unix.o: fcgi/libfcgi/os_unix.c fcgi/include/fcgi_config.h \
		fcgi/include/fastcgi.h \
		fcgi/include/fcgimisc.h \
		fcgi/include/fcgios.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/fcgiapp-obj/os_unix.o fcgi/libfcgi/os_unix.c
